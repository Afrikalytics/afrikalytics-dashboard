      ...
      <main className="lg:ml-64 p-4 lg:p-8 pt-16 lg:pt-8">
        <div className="max-w-3xl">
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h1 className="text-2xl lg:text-3xl font-bold text-gray-900">Modifier l'Étude</h1>
              <p className="text-gray-600 mt-1">Modifiez les informations de cette étude</p>
            </div>
          </div>
