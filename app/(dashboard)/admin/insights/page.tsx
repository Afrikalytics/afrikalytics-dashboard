    ...
    >
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-surface-500 mt-1">
            Rédigez des analyses pour les études fermées
          </p>
        </div>
      ...
      {getClosedStudies().length === 0 && (
        <Alert variant="warning" title="Information">
          Aucune étude fermée pour le moment. Les insights ne peuvent être créés
          que pour des études avec le statut &quot;Fermé&quot;.
        </Alert>
      )}
