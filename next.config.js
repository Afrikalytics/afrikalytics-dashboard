    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:; font-src 'self' data: https://fonts.gstatic.com; connect-src 'self' https://*.up.railway.app https://*.vercel.app https://*.ingest.sentry.io; frame-src https://lookerstudio.google.com https://app.powerbi.com https://public.tableau.com https://datastudio.google.com;",
          },
        ],
      },
    ];
